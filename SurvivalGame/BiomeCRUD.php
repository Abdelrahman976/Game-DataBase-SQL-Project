...
if ( isset($_POST['name']) && isset($_POST['rarity'])) {
    
    $biome = new Biome($_POST["name"], $_POST["rarity"]);
    $biome->add();
    header("Location: BiomeCRUD.php");
    return;
}
?>
<!DOCTYPE html>
...
<head>
        ...
        <title>Biome CRUD</title>
</head>
<body>
<header>
        <h1>Biome Database</h1>
        <nav>
            <ul>
...
<div class="container">
   ...
   <div class="admin-object-form-container">
      ...
      <form  method="post">
         <h3>Add a new Biome</h3>
         <input type="text" placeholder="enter Biome name" name="name" class="box" required>
         <input type="text" placeholder="enter Biome Rarity" name="rarity" class="box" required>
         <input type="submit" class="btn" name="add_biome" value="Create">
      </form>
