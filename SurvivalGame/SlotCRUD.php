...
if ( isset($_POST['quantity'])) {
    ...
    $slot = new Slot($_POST["quantity"]);
    $slot->add();
    header("Location: SlotCRUD.php");
    return;
}
?>
<!DOCTYPE html>
...
<div class="container">
   ...
   <div class="admin-object-form-container">
      ...
      <form  method="post">
         ...
         <input type="text" placeholder="enter slot's Quantity" name="quantity" class="box" required>
